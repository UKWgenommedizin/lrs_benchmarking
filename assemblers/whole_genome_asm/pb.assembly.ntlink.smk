# ************************************************************************************************
# ntLink Pacbio HiFi whole-genome scaffolding
# ************************************************************************************************
...
# Only PacBio HiFi whole-genome datasets are included.
# 1k, chromosome 21, and local validation datasets are intentionally excluded.
DATASETS = [
    dataset
...
# Expand the output pattern into one concrete target path for each discovered dataset.
OUTPUT += expand(CWD + "/assemblies/ntlink/{dataset}/assembly.fasta",dataset=DATASETS)
