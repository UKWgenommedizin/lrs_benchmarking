...
OUTPUT = OUTPUT + expand(CWD + "/vcf_called/snv_indel/{dataset}.hg38.{mapper}.dv-wgs-woPG.vcf.gz", zip, dataset=DATASETS, mapper=MAPPERS)

OUTPUT = OUTPUT + expand(CWD + "/vcf_called/snv_indel/{dataset}.hg38.{mapper}.dv-wgs-woPG.visual_report.html", zip, dataset=DATASETS, mapper=MAPPERS)

OUTPUT = OUTPUT + expand(CWD + "/vcf_called/snv_indel/{dataset}.hg38.{mapper}.dv-wgs-woPG.vcf.gz.stats", zip, dataset=DATASETS, mapper=MAPPERS)
...
rule deepvariant_gpu_make_examples:
    ...
    output:  examples=temp(expand("{{cwd}}/vcf_called/snv_indel/tmp/{{dataset}}.hg38.{{mapper}}.dv-wgs-woPG/make_examples.tfrecord-00{scatter_index}-of-00064.gz", scatter_index=MAKE_EXAMPLES_SCATTER_INDICES)), gvcf=temp(expand("{{cwd}}/vcf_called/snv_indel/tmp/{{dataset}}.hg38.{{mapper}}.dv-wgs-woPG/gvcf.tfrecord-00{scatter_index}-of-00064.gz", scatter_index=MAKE_EXAMPLES_SCATTER_INDICES))
    params:  examples="{cwd}/vcf_called/snv_indel/tmp/{dataset}.hg38.{mapper}.dv-wgs-woPG/make_examples.tfrecord@64.gz", gvcf="{cwd}/vcf_called/snv_indel/tmp/{dataset}.hg38.{mapper}.dv-wgs-woPG/gvcf.tfrecord@64.gz", log="{cwd}/vcf_called/snv_indel/{dataset}.hg38.{mapper}.dv-wgs-woPG.make_examples.log"
...
#--normalize_reads \
#/opt/deepvariant/bin/make_examples --mode calling --ref "/mnt/storage/db/references/GRCh38_GIABv3_no_alt_analysis_set_maskedGRC_decoys_MAP2K3_KMT2C_KCNJ18.fasta" --reads "/mnt/storage/genetic_data/WGS_LR/Tests/lrs_benchmarking/cram/HG002.ont.1k.hg38.mm2-ont.cram" --examples "/mnt/storage/genetic_data/WGS_LR/Tests/lrs_benchmarking/vcf_called/snv_indel/tmp/HG002.ont.1k.hg38.mm2-ont.dv-wgs-woPG/intermediate_results_dir/make_examples.tfrecord@64.gz" --checkpoint "/opt/models/wgs" --call_small_model_examples --small_model_indel_gq_threshold "28" --small_model_snp_gq_threshold "20" --small_model_vaf_context_window_size "51" --track_ref_reads --trained_small_model_path "/opt/smallmodels/wgs"


rule deepvariant_gpu_call_variants:
    input:   examples=expand("{{cwd}}/vcf_called/snv_indel/tmp/{{dataset}}.hg38.{{mapper}}.dv-wgs-woPG/make_examples.tfrecord-00{scatter_index}-of-00064.gz", scatter_index=MAKE_EXAMPLES_SCATTER_INDICES)
    output:  call_variants_output=temp(expand("{{cwd}}/vcf_called/snv_indel/tmp/{{dataset}}.hg38.{{mapper}}.dv-wgs-woPG/call_variants-00{scatter_index}-of-00016.tfrecord.gz", scatter_index=CALL_VARIANTS_SCATTER_INDICES))
    params:  examples="{cwd}/vcf_called/snv_indel/tmp/{dataset}.hg38.{mapper}.dv-wgs-woPG/make_examples.tfrecord@64.gz", call_variants_output="{cwd}/vcf_called/snv_indel/tmp/{dataset}.hg38.{mapper}.dv-wgs-woPG/call_variants.tfrecord.gz", log="{cwd}/vcf_called/snv_indel/{dataset}.hg38.{mapper}.dv-wgs-woPG.call_variants.log"
    message: "executing {rule} with output {output} and input {input}"
    priority: 10
    threads: 32
    resources:
...
rule deepvariant_gpu_postprocess_variants:
    input:   call_variants_output=expand("{{cwd}}/vcf_called/snv_indel/tmp/{{dataset}}.hg38.{{mapper}}.dv-wgs-woPG/call_variants-00{scatter_index}-of-00016.tfrecord.gz", scatter_index=CALL_VARIANTS_SCATTER_INDICES), gvcf=expand("{{cwd}}/vcf_called/snv_indel/tmp/{{dataset}}.hg38.{{mapper}}.dv-wgs-woPG/gvcf.tfrecord-00{scatter_index}-of-00064.gz", scatter_index=MAKE_EXAMPLES_SCATTER_INDICES), fasta=FASTA_PATH
    output:  vcf_gz="{cwd}/vcf_called/snv_indel/{dataset}.hg38.{mapper}.dv-wgs-woPG.vcf.gz"
    params:  call_variants_output="{cwd}/vcf_called/snv_indel/tmp/{dataset}.hg38.{mapper}.dv-wgs-woPG/call_variants.tfrecord.gz", gvcf="{cwd}/vcf_called/snv_indel/tmp/{dataset}.hg38.{mapper}.dv-wgs-woPG/gvcf.tfrecord@64.gz", log="{cwd}/vcf_called/snv_indel/{dataset}.hg38.{mapper}.dv-wgs-woPG.postprocess_variants.log"
    message: "executing {rule} with output {output} and input {input}"
    priority: 8
    threads: 16
    resources:
...
rule deepvariant_cpu_only:
    input:   cram="{cwd}/cram/{dataset}.hg38.{mapper}.cram", crai="{cwd}/cram/{dataset}.hg38.{mapper}.cram.crai", fasta=FASTA_PATH
    output:  vcf_gz="{cwd}/vcf_called/snv_indel/{dataset}.hg38.{mapper}.dv-wgs-woPG.vcf.gz"
    params:  intermediate_results_dir="{cwd}/vcf_called/snv_indel/tmp/{dataset}.hg38.{mapper}.dv-wgs-woPG/intermediate_results_dir", logging_dir="{cwd}/vcf_called/snv_indel/tmp/{dataset}.hg38.{mapper}.dv-wgs-woPG/logging_dir"
    message: "executing {rule} with output {output} and input {input}"
    threads: 64
    resources:
	    mem_gb=160
...
rule deepvariant_visual_report:
    input:   vcf_gz="{cwd}/vcf_called/snv_indel/{dataset}.hg38.{mapper}.dv-wgs-woPG.vcf.gz"
    output:  visual_report="{cwd}/vcf_called/snv_indel/{dataset}.hg38.{mapper}.dv-wgs-woPG.visual_report.html"
    params:  prefix="{cwd}/vcf_called/snv_indel/{dataset}.hg38.{mapper}.dv-wgs-woPG", log="{cwd}/vcf_called/snv_indel/{dataset}.hg38.{mapper}.dv-wgs-woPG.visual_report.log"
    message: "executing {rule} with output {output} and input {input}"
    priority: 2
    threads: 2
    resources:
...
rule bcftools_stats:
    input:   vcf_gz="{cwd}/vcf_called/snv_indel/{dataset}.hg38.{mapper}.dv-wgs-woPG.vcf.gz", fasta=FASTA_PATH
    output:  stats="{cwd}/vcf_called/snv_indel/{dataset}.hg38.{mapper}.dv-wgs-woPG.vcf.gz.stats"
